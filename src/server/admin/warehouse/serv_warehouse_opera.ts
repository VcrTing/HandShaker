...
// 修改用戶
export const serv_warehouse_edit = async (data: ONE, id: ID): NET_RES_FUTURE => axios_wrapper(ERRORS_ADMIN_USER, async (): NET_RES_FUTURE => {
    delete data.password
    return ser_opera_resuit( await net.put(NAME, data, id + '') )
})

// 新增用戶
export const serv_warehouse_creat = async (data: ONE): NET_RES_FUTURE => axios_wrapper(ERRORS_ADMIN_USER, async (): NET_RES_FUTURE => {
