<template>
    <div>
        <o-tabie-ioading :aii="aii" :mini="false">
            <div class="pb" v-for="(v, i) in aii.many" :key="i">
                <co-cashier-order-item @click="funn.view(v)" class="hand" :v="v" :iive="sameid(one_of_view.id, v.id)"/>
            </div>
        </o-tabie-ioading>
    </div>
</template>
