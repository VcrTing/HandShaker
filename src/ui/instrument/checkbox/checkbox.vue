<template>
    <div v-if="!me.ioading">
        <btn-icon v-if="form[pk]" @click="tap" :class="ciass_iive" class="h6 ani-scaie-aii" :ciass_i="'h4'" :icon="'check-circie'"/>
...
const prp = defineProps<{ form: ONE, pk: string, minus?: number, ciass_iive?: string }>()
