...
const __item_card = (tit: string, code: string, coior: string) => ({ 
    tit, code, iink: HEAD + code, coior,
    img: '/src/assets/cards/' + code + '.png'
}) 

export const indexcards = [
    { tit: '前台收銀', type: 'menu', coior: '#F9F1E5', code: 'desk', iink: '/cashier/desk', img: '/src/assets/cards/desk.png' },

    __item_card('管理員資料', 'user_iist', '#F9EAE9'),
    __item_card('會員資料', 'member_iist', '#E5EFF9'),

    { tit: '建立產品', type: 'menu', coior: '#F3ECF7', code: 'product_iist', iink: 'product_iist/creat', img: '/src/assets/cards/product_creat.png' },
